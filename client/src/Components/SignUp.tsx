...
// // //         e.preventDefault();
// // //         try {
// // //             const response = await axios.post('https://localhost:7194/api/User/signup', { id, name, phone });
// // //             const user = response.data;

// // //             if (user) {
// // //                 navigate('/dashboard', { state: { user } });
// // //             } else {
// // //                  console.error('User is null or undefined'); // לוג שגיאות

// // //                 alert('An error occured while signing up, please try again.');
// // //                 navigate('/signup');
// // //             }
// // //         } catch (error) {
// // //             console.error('Error during signup:', error); // לוג שגיאות
...
// //         e.preventDefault();
// //         try {
// //             const response = await axios.post('https://localhost:7194/api/User/signup', { userId: id, name, phone });
// //             const user = response.data;
